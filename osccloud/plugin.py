...
DEFAULT_OSCCLOUD_API_VERSION = '1'

# Required by the OSC plugin interface
API_NAME = 'osccloud'
API_VERSION_OPTION = 'os_osccloud_api_version'
API_VERSIONS = {
    '1': 'osccloud.plugin.EmptyClient',
}
...
def build_option_parser(parser):
    ...
    """
    parser.add_argument(
        '--os-%s-api-version' % API_NAME,
        metavar='<%s-api-version>' % API_NAME,
        default=utils.env(
            'OS_OSCCLOUD_API_VERSION',
            default=DEFAULT_OSCCLOUD_API_VERSION),
        help='OSC Cloud API version, default=' +
             DEFAULT_OSCCLOUD_API_VERSION +
             ' (Env: OS_OSCCLOUD_API_VERSION)')
    return parser
